...
namespace EatwellApi.Persistence.Migrations
{
    ...
    [Migration("20250827205808_AddHeadOfficeEntity")]
    partial class AddHeadOfficeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Concrete.BaseEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2025, 8, 27, 23, 58, 8, 172, DateTimeKind.Local).AddTicks(2412));
            ...
            modelBuilder.Entity("Entities.Concrete.PageContent", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 27, 23, 58, 8, 173, DateTimeKind.Local).AddTicks(3868));
