...
namespace EatwellApi.Persistence.Migrations
{
    ...
    [Migration("20250901072206_RenameOrderProductToOrderProducts")]
    partial class RenameOrderProductToOrderProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Concrete.BaseEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2025, 9, 1, 10, 22, 5, 837, DateTimeKind.Local).AddTicks(2515));
            ...
            modelBuilder.Entity("Entities.Concrete.PageContent", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 9, 1, 10, 22, 5, 838, DateTimeKind.Local).AddTicks(6816));
